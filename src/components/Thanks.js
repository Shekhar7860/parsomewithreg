...
export default class Terms extends Component {
  ...
  render() {
    ...
    return (
      ...
      <View style={{flex:1, justifyContent : "center", algnItems : "center",  backgroundColor : "#686de0"}}>
        <Text style={{textAlign : "center", flex : 1,justifyContent : "center", marginTop : 180, fontSize : 25, color : "white"}}>Thanks For Registeration. Please Wait Until You Receive A Verification Email</Text>
